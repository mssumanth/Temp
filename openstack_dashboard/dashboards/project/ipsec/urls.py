...
from .views import IndexView, CreateNetworkView, CreateVPNView
...
urlpatterns = patterns('openstack_dashboard.dashboards.project.ipsec.views',
    url(r'^$', IndexView.as_view(), name='index'),
    url(r'^create/$', CreateNetworkView.as_view(), name='create'),
    url(r'^createvpn/$', CreateVPNView.as_view(), name='createvpn'),
